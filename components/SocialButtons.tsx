...
export function FacebookButton(props: SocialButtonProps) {
  return (
    <Button
...
export function DiscordButton(props: SocialButtonProps) {
  return (
    <Button
...
export function TwitterButton(props: SocialButtonProps & React.ComponentPropsWithoutRef<'a'>) {
  return (
    <Button
      component="a"
